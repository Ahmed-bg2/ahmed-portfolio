...
export function HeroSection() {
  return (
    <section id="home" className="section-shell flex min-h-screen items-center pb-20 pt-32">
      <div className="mx-auto grid w-full items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div
          className="max-w-3xl"
          variants={container}
          initial="hidden"
        ...
        >
          <motion.div
            variants={item}
            className="mb-7 inline-flex items-center gap-2 rounded-full border border-cyan-200/[0.16] bg-slate-950/45 px-4 py-2 text-sm text-cyan-50 shadow-[0_0_38px_rgba(34,211,238,0.16)] backdrop-blur-xl"
          >
            <Sparkles className="h-4 w-4 text-cyan-100" aria-hidden="true" />
            Software engineering portfolio / AI-ready systems
          </motion.div>
          ...
          <motion.p variants={item} className="mt-6 text-xl font-medium text-slate-200 sm:text-2xl">
            <motion.span
          ...
          <motion.div variants={item} className="mt-7 flex max-w-2xl flex-wrap gap-2.5">
          ...
          <motion.a
            variants={item}
            href="#about"
            className="mt-12 inline-flex items-center gap-2 text-sm font-medium text-slate-400 transition hover:text-cyan-100"
          >
